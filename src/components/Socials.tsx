...
const Socials = () => {
  return (
    <div className='absolute -right-18 flex flex-col gap-2.5 p-1.5 lg:hover:-translate-x-18 transition-transform duration-200 ease-out bg-white border-l-2 border-y-2 border-primary text-black font-bold'>
      <a
