      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-4 items-center sm:scale-100 scale-70">
          ...
          <div className="flex gap-1">
            Built with
            <Link href={"https://nextjs.org/"} underlined title={`${"https://nextjs.org/"}`} target="_blank">
              Next.js
            </Link>
            •
            <Link href={"https://www.typescriptlang.org/"} underlined title={`${"https://www.typescriptlang.org/"}`} target="_blank">
              TypeScript
            </Link>
            •
        ...
        <div className="w-full relative flex md:flex-row md:justify-between md:gap-0 md:mb-8 sm:scale-100 flex-col items-center justify-center gap-4 scale-70">
          <div className="flex items-center gap-2">
            ...
            <>
              ...
              <button onClick={copyText} title="Click to copy email" className="flex items-center lg:hover:cursor-pointer underline">
                kfeng58@uwo.ca
              </button>
            </>
          </div>
          <h6 className="flex gap-1">
            Released under the
            <Link underlined href={"https://mit-license.org/"} title={`${"https://mit-license.org/"}`} target="_blank">
              MIT License
            </Link>
          </h6>
