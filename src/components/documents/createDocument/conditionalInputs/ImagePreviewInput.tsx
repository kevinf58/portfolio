...
const ImagePreviewInput = () => {
  ...
  const { imageInputPreviewRef, imagePreview, setImagePreview } = context;
  ...
  return (
    <label
      ...
      title={imagePreview || "Choose an image"}
    >
      ...
      <span className="ml-auto text-[10px] text-dark-white truncate max-w-40">{imagePreview || "No file chosen"}</span>
