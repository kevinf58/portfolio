...
const Card = (props: BaseCardProps) => {
  const cardStyles = `h-fit flex items-center px-4 pt-1.5 pb-2 gap-1 rounded-sm border-1 border-tint/10 bg-white/8 hover:scale-105 duration-100 cursor-pointer
